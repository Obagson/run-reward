;; ===========================================
;; Run Reward - Performance Incentive Smart Contract
;; ===========================================
;; This contract manages a decentralized performance reward system,
;; enabling community-driven incentive allocation through transparent
;; governance, milestone tracking, and dynamic voting mechanisms.
